...
<script src="../common/slimScroll.min.js"></script>
<script src="../common/jquery.nivo.slider.pack.js"></script>
<script src="../common/jquery.nivo.slider.pack.js"></script>
<link rel="stylesheet" type="text/css" href="../fonts/stylesheet.css"/>
<link rel="stylesheet" type="text/css" href="../common/stylesheet.css"/>
<link rel="stylesheet" type="text/css" href="../common/accordion.css"/>
...
<div class="header">
    ...
    <img src="../common/pointer-right.png"></img>
    </button>
    </form>
    </div>
	</div>
</div>  <div id="contents" style="min-height:40px">
	...
	<div class="accordion-content-1">
		...
		<ul><li><a href="../nstitute/#/mou" title="">International Relations</a></li>

    ...
    $.fn.extend({
        vscroller: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.newsfeed == '') { alert('No php file specified'); return; }
                $.ajax({
                    ...
                    success: function (php) {
                        ...
                        newsHeader.html($(php).find('newslist').attr('title'));
                        var i = 0;
                        totalElements = $(php).find('news').length;
                        $(php).find('news').each(function () {
